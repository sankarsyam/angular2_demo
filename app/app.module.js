...
require("./lib/rxjs-extensions");
// Imports for loading & configuring the in-memory web api
var angular_in_memory_web_api_1 = require("angular-in-memory-web-api");
var in_memory_data_service_1 = require("./inmemory/in-memory-data.service");
...
AppModule = __decorate([
    core_1.NgModule({
        ...
        declarations: [
            ...
            employee_home_component_1.EmployeeHome,
            http_test_component_1.HTTPTestComponent,
            paging_table_component_1.PagingTable
        ],
        providers: [employee_service_1.EmployeeService, state_service_1.StateService],
        bootstrap: [
            app_component_1.AppComponent
        ]
    }),
